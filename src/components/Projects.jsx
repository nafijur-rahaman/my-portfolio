    ...
    {selectedProject && (
      ...
      >
        ...
        >
          ...
          {/* Close Button */}
          <button
            className="absolute top-4 right-4 text-black bg-white w-8 h-8 rounded-full font-bold hover:bg-cyan-400 hover:text-white flex items-center justify-center"
            onClick={() => setSelectedProject(null)}
          >
            ×
          </button>
